...
export default function VendorDetailPage() {
  ...
  // TODO: Implement AP aging procedure
  const apAging = null;
    ...
    <div className="w-full p-4 sm:p-6 lg:p-8">
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 sm:mb-8 gap-4">
        ...
        <div className="flex gap-2">
          ...
          <Link href={`/master/vendors/${vendorId}/edit`}>
            <Button>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <p className="text-lg font-semibold">
                    {formatCurrency(vendor.creditLimit?.toString() || '0')}
                  </p>
                </div>
                <div>
                  <p className="text-sm font-medium">Payment Terms</p>
                  <p className="text-lg font-semibold">
                    {vendor.paymentTerms || 0} days
                  </p>
                </div>
              </div>
              ...
              {vendor.npwp && (
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">{vendor.npwp}</p>
                </div>
              )}
        ...
        <div className="space-y-6">
          ...
          <Card>
            ...
            <CardContent className="space-y-2">
              <Link href={`/purchases/bills/new?vendorId=${vendorId}`} className="block">
                <Button variant="outline" className="w-full justify-start">
                  <Calendar className="h-4 w-4 mr-2" />
                  Create Bill
                </Button>
              </Link>
              <Link href={`/purchases/payments/new?vendorId=${vendorId}`} className="block">
                <Button variant="outline" className="w-full justify-start">
